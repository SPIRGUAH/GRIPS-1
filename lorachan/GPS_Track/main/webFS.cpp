...
#define  FS LittleFS             // In preparation for the introduction of LITTLFS see https://github.com/lorol/LITTLEFS replace SPIFFS with LITTLEFS
...
void Home() {
  webpage = HTML_Header();
  webpage += "<h1>UAH Balloon Page</h1>";
  webpage += "<h2>Datalog downloader</h2>";
...
String HTML_Header() {
  ...
  page += "<style>";
  page += "body {width:75em;margin-left:auto;margin-right:auto;font-family:Arial,Helvetica,sans-serif;font-size:16px;color:blue;background-color:#B1B1ff;text-align:center;}";
...
String HTML_Footer() {
  String page;
  page += "<br><br><footer>";
  page += "<p class='medium'>UAH Balloon Filesystem</p>";
  page += "<p class='ps'>Based on D L Bird work 2021 Version " +  Version + "</p>";
  page += "</footer>";
  page += "</body>";
  page += "</html>";
  return page;
