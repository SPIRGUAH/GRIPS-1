...
int LoRaReceive() 
{
    ...
    if (packetSize) 
    {
        ...
        //Serial.println("Latitud: %3.6f, Longitude: %3.6f", latitude, longitude);
...
void reconnect() 
{
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect("H3")) { // Client name needs to be unique for each network logged in the same MQTT port
...
void axp2101Init() {
    if (axp2101_found) {
        ...
        // Configuración y activación de salidas de potencia
        ...
        // Configuración de voltajes y activación de reguladores
        ...
        * */
        ...
        // Deshabilitamos irq del axp para luego definirlas de nuevo
...
void setup()
{
    ...
    int selection = 0; // Cambia este número para elegir el broker (0, 1 o 2)

    // Selecciona el broker
